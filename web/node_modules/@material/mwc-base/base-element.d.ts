...
import { LitElement } from '@material/mwc-base/node_modules/lit-element';
import { Constructor } from '@material/mwc-base/utils';
export { CustomEventListener, EventType, SpecificEventListener } from '@material/base/types';
export { addHasRemoveClass } from '@material/mwc-base/utils';
/** @soyCompatible */
